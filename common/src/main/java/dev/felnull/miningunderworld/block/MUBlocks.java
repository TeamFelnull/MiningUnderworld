...
public class MUBlocks {
    ...
    public static final RegistrySupplier<Block> TAR_STAINS = register("tar_stains", () -> new TarStainsBlock(BlockBehaviour.Properties.of(Material.WATER, MaterialColor.COLOR_BLACK).noCollission().strength(0.5F).sound(SoundType.GRAVEL)));
    public static final RegistrySupplier<Block> SMALL_TAR_STAINS = register("small_tar_stains", () -> new TarStainsBlock(BlockBehaviour.Properties.of(Material.WATER, MaterialColor.COLOR_BLACK).noCollission().strength(0.5F).sound(SoundType.GRAVEL)));
    public static final RegistrySupplier<Block> SOLID_TAR = register("solid_tar", () -> new SolidTarBlock(BlockBehaviour.Properties.of(Material.DIRT, MaterialColor.DIRT).strength(0.5F).sound(SoundType.GRAVEL)));
