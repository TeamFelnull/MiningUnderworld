...
public interface MUBlocks {
    ...
    RegistrySupplier<Block> UNSTABLE_STANCE = register("unstable_stance", () -> new CollapsingBlock(1F, 1F));
    RegistrySupplier<Block> COLLAPSING_STANCE = register("collapsing_stance", () -> new CollapsingBlock(0.5F, 8F));
