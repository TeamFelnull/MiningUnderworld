...
public class MUItems {
    ...
    public static final RegistrySupplier<Item> COPPER_PICKAXE = register("copper_pickaxe", () -> new OxidizingSwordItem(MUTiers.COPPER, 1, -2.8F, new Item.Properties().arch$tab(MUCreativeModeTab.MOD_TAB)));
