...
public interface MUItems {
    ...
    RegistrySupplier<Item> COPPER_HELMET = register("copper_helmet", p -> new WeatheringArmorItem(MUArmorMaterials.COPPER, EquipmentSlot.HEAD, p));
    RegistrySupplier<Item> COPPER_CHESTPLATE = register("copper_chestplate", p -> new WeatheringArmorItem(MUArmorMaterials.COPPER, EquipmentSlot.CHEST, p));
    RegistrySupplier<Item> COPPER_LEGGINGS = register("copper_leggings", p -> new WeatheringArmorItem(MUArmorMaterials.COPPER, EquipmentSlot.LEGS, p));
    RegistrySupplier<Item> COPPER_BOOTS = register("copper_boots", p -> new WeatheringArmorItem(MUArmorMaterials.COPPER, EquipmentSlot.FEET, p));
    ...
    RegistrySupplier<Item> EMERALD_HELMET = register("emerald_helmet", p -> new ArmorItem(MUArmorMaterials.EMERALD, EquipmentSlot.HEAD, p));
    RegistrySupplier<Item> EMERALD_CHESTPLATE = register("emerald_chestplate", p -> new ArmorItem(MUArmorMaterials.EMERALD, EquipmentSlot.CHEST, p));
    RegistrySupplier<Item> EMERALD_LEGGINGS = register("emerald_leggings", p -> new ArmorItem(MUArmorMaterials.EMERALD, EquipmentSlot.LEGS, p));
    RegistrySupplier<Item> EMERALD_BOOTS = register("emerald_boots", p -> new ArmorItem(MUArmorMaterials.EMERALD, EquipmentSlot.FEET, p));
    RegistrySupplier<Item> AMETHYST_INGOT = register("amethyst_ingot");
    RegistrySupplier<Item> AMETHYST_HELMET = register("amethyst_helmet", p -> new ArmorItem(MUArmorMaterials.AMETHYST, EquipmentSlot.HEAD, p));
    RegistrySupplier<Item> AMETHYST_CHESTPLATE = register("amethyst_chestplate", p -> new ArmorItem(MUArmorMaterials.AMETHYST, EquipmentSlot.CHEST, p));
    RegistrySupplier<Item> AMETHYST_LEGGINGS = register("amethyst_leggings", p -> new ArmorItem(MUArmorMaterials.AMETHYST, EquipmentSlot.LEGS, p));
    RegistrySupplier<Item> AMETHYST_BOOTS = register("amethyst_boots", p -> new ArmorItem(MUArmorMaterials.AMETHYST, EquipmentSlot.FEET, p));
    ...
    RegistrySupplier<Item> REDSTONE_CHESTPLATE = register("redstone_chestplate", p -> new ArmorItem(MUArmorMaterials.REDSTONE, EquipmentSlot.CHEST, p));
    RegistrySupplier<Item> REDSTONE_LEGGINGS = register("redstone_leggings", p -> new ArmorItem(MUArmorMaterials.REDSTONE, EquipmentSlot.LEGS, p));
    RegistrySupplier<Item> REDSTONE_BOOTS = register("redstone_boots", p -> new ArmorItem(MUArmorMaterials.REDSTONE, EquipmentSlot.FEET, p));
    ...
    RegistrySupplier<Item> LAPIS_LAZULI_CHESTPLATE = register("lapis_lazuli_chestplate", p -> new ArmorItem(MUArmorMaterials.LAPIS_LAZULI, EquipmentSlot.CHEST, p));
    RegistrySupplier<Item> LAPIS_LAZULI_LEGGINGS = register("lapis_lazuli_leggings", p -> new ArmorItem(MUArmorMaterials.LAPIS_LAZULI, EquipmentSlot.LEGS, p));
    RegistrySupplier<Item> LAPIS_LAZULI_BOOTS = register("lapis_lazuli_boots", p -> new ArmorItem(MUArmorMaterials.LAPIS_LAZULI, EquipmentSlot.FEET, p));
