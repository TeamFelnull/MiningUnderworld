...
public class MUEntityTypes {
    ...
    public static final RegistrySupplier<EntityType<StrictFallingTileEntity>> STRICT_FALLING_BLOCK = register("strict_falling_block", EntityType.Builder.of(StrictFallingTileEntity::new, MobCategory.MISC).sized(0.98F, 0.98F).clientTrackingRange(10).updateInterval(20));
